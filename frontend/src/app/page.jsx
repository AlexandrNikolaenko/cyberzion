...
export default function Home() {
  ...
  return (
    <main>
      <section id="intro">
        <div className="wrapper">
          ...
          <div className="max-w-[456px] leading-[150%] text-base text-[#C3C3C3] mb-[90px]">
            Превращаем сложные процессы в простые решения — автоматизация, интеграции и цифровизация под ключ!
          </div>
          <div className="flex gap-5">
            <AccentAngleButton onClick={() => {}}>Обсудить проект</AccentAngleButton>
      ...
      <section id="scroll-line">
        <ul>
          <li><Image src={'/Company1.svg'} alt="company" width={127} height={43} /></li>
          <li><Image src={'/Company1.svg'} alt="company" width={127} height={43} /></li>
          <li><Image src={'/Company1.svg'} alt="company" width={127} height={43} /></li>
          <li><Image src={'/Company1.svg'} alt="company" width={127} height={43} /></li>
          <li><Image src={'/Company1.svg'} alt="company" width={127} height={43} /></li>
        ...
        <div className="wrapper">
          ...
          <div id="services-info">
            <ul>
              {
                services.map(elem => (
                  <li key={elem.id} onClick={() => handleChooseService(elem.id)} className={elem.id == activeService ? "enable-service" : "disable-service"}>
                    ...
                    <Image src={'/arrow-button.svg'} width={36} height={36} alt="arrow" className={`${elem.id != activeService && 'opacity-0'}`}/>
                  </li>
                ))
              }
            </ul>
  ...
  так и сложные <br/>
  веб-приложение и сайты<br/>
                </h3>
                <div className="w-full">
                  <Link href={'/#'} className="flex w-fit gap-[13px] items-center bg-accent rounded-full py-[10.5px] px-[18px] text-white">
                    Подробнее
                    <Image src={'/angle-arrow.svg'} width={20} height={20} alt="arrow"/>
                  </Link>
                </div>
              </div>
            </Card>
